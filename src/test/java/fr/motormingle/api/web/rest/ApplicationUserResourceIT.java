...
class ApplicationUserResourceIT {
    ...
    void createApplicationUser() throws Exception {
        ...
        assertThat(testApplicationUser.getTag()).isEqualTo(DEFAULT_TAG);
        ...
        assertThat(testApplicationUser.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    }
    ...
    void putExistingApplicationUser() throws Exception {
        ...
        ApplicationUser testApplicationUser = applicationUserList.get(applicationUserList.size() - 1);
        assertThat(testApplicationUser.getTag()).isEqualTo(UPDATED_TAG);
        ...
        assertThat(testApplicationUser.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
    }
    ...
    void partialUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.tag(UPDATED_TAG).birthDate(UPDATED_BIRTH_DATE);
